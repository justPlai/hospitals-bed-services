                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col" style="position: relative; margin-top:5%">
                                ...
                                <input type="text" class="form-control" name="hospital_name" /><br>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col" style="position: relative; margin-top:5%">
                                ...
                                <input type="text" class="form-control" name="hospital_location"/><br>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col" style="position: relative; margin-top:5%">
                                ...
                                <input type="text" class="form-control" name="hospital_phonenumber"/><br>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col" style="position: relative; margin-top:5%">
                                <button class="btn btn-success" type="submit" name="action" value="create">เพิ่มข้อมูล</button>
